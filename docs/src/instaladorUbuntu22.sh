...
if [ ! -d "CoppeliaSim_Edu_V4_9_0_rev6_Ubuntu22_04" ]; then
  ...
  tar -xvJf CoppeliaSim_Edu_V4_9_0_rev6_Ubuntu22_04.tar.xz
  rm -rf CoppeliaSim_Edu_V4_9_0_rev6_Ubuntu22_04.tar.xz
fi