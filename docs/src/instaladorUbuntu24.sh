...
if [ ! -d "CoppeliaSim_Edu_V4_9_0_rev6_Ubuntu24_04" ]; then
  ...
  tar -xvJf CoppeliaSim_Edu_V4_9_0_rev6_Ubuntu24_04.tar.xz
  rm -rf CoppeliaSim_Edu_V4_9_0_rev6_Ubuntu24_04.tar.xz
  sudo apt install -y libgl1-mesa-dev
  sudo apt install -y python3-zmq python3-cbor2
fi
