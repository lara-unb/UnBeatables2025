...
sys.path.append(os.path.join(sys.path[0], 'action'))
sys.path.append(os.path.join(sys.path[0], 'behavior'))
sys.path.append(os.path.join(sys.path[0], 'perception'))
sys.path.append(os.path.join(sys.path[0], 'communication'))
sys.path.append(os.path.join(sys.path[0], 'communication/gameController'))
