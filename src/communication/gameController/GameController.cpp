...
RoboCupGameControlData GameController::convertToRoboCupGameData(std::vector<uint8_t> data) {
...
std::vector<uint8_t> GameController::convertToVector(const UnBeatablesReturnBoard& data) {
